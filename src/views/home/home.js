...
import {faGem, faLaptopCode, faGlobe, faHeart, faEnvelope, faPhone} from '@fortawesome/free-solid-svg-icons';
              ...
              <div className="col-lg-8 text-center">
                ...
                <hr className="divider light my-4" />
                  <p className="text-white-50 mb-4">Start Bootstrap has everything you need to get your new website up
                    and running in no time! Choose one of our open source, free to download, and easy to use themes! No
                    strings attached!</p>
